...
public class Verify_Booking_History {
	private WebDriver driver;
	WebDriverWait wait;

	public Verify_Booking_History(WebDriver driver) {
		this.driver = driver;
	}
	...
	private By history = By.xpath("//a[normalize-space()='History']");
	private By verifyfacility = By.xpath("//*[contains(text(),'Tokyo CURA Healthcare Center')]");
	...
	public void historyclick() {
		WebElement clichistory = driver.findElement(history);
		clichistory.click();
	}
	public boolean isfacilityvisible() {
		return driver.findElement(verifyfacility).isDisplayed();
	}

	public void verifyfacilityvisible() {
		Assert.assertTrue(isfacilityvisible(), "FACILITY NOT SELECTED");
