...
public class Verify_Profile {
	private WebDriver driver;
	WebDriverWait wait;

	public Verify_Profile(WebDriver driver) {
		this.driver = driver;
	}
	...
	private By verifyprofileconstruction = By.xpath("//*[contains(text(),'Under construction.')]");
	...
	public boolean isprofileUnderconstructionvisible() {
		return driver.findElement(verifyprofileconstruction).isDisplayed();
	}

	public void verifyunderconstruction() {
		Assert.assertTrue(isprofileUnderconstructionvisible(), "PROFILE NOT VISIBLE");
